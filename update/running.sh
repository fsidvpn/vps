...
if [ "${status_text}" == "active" ]                                                     
then                                                                                    
echo -e " Websocket DROPBEAR        : Websocket DROPBEAR Service is "$green"running"$NC""                  
else                                                                                    
echo -e " Websocket DROPBEAR          : Websocket DROPBEAR Service is "$red"not running (Error)"$NC""        
fi
