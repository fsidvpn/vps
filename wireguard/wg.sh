...
# Link Hosting Kalian
fsid="raw.githubusercontent.com/fsidvpn/vps/main/wireguard"
...
echo -e "${Info} Wireguard Script By fsidvpn"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://${fsid}/addwg.sh"
wget -O delwg "https://${fsid}/delwg.sh"
wget -O renewwg "https://${fsid}/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
